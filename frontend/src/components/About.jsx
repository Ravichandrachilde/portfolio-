        ...
        <div className="about-grid">
          <div className="about-content">
            ...
            <div className="body-text mb-24">
              <p className="mb-16">
                Data Scientist with a Master's in Information Technology and expertise in Python, SQL, and Statistical Analysis. 
                Proven ability to derive actionable business insights through Exploratory Data Analysis (EDA) and predictive modeling.
              </p>
              <p className="mb-16">
                Skilled in communicating complex data findings via visualization tools and delivering end-to-end ML solutions. 
                My work spans from data cleaning and preprocessing to deploying production-ready models, with hands-on experience 
                in cloud platforms and MLOps practices.
              </p>
              <p>
