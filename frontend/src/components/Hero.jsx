...
const Hero = () => {
  ...
  const handleDownloadResume = () => {
    ...
    window.open('https://drive.google.com/file/d/1Vm23BdDNoAdzOIEx0u_zdzkxqjuaJrc8/view?usp=sharing', '_blank');
  };
    ...
    <section id="home" className="hero-section">
      <div className="container">
        <div className="hero-content">
          <div className="hero-label label-text">DATA SCIENTIST</div>
          ...
          <p className="hero-description body-large">
            Data Scientist who loves turning messy data into clear insights. I build predictive models 
            and use tools like Python, SQL, and SHAP to help businesses make better decisions. I enjoy 
            the full journey, from exploring data to deploying models that actually get used.
          </p>
