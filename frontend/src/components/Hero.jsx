...
const Hero = () => {
  ...
  const handleDownloadResume = () => {
    ...
    window.open('https://drive.google.com/file/d/16YcAvU6TDYefpsywK5d5Zwue7IYW3qyX/view', '_blank');
  };
      ...
      <div className="container">
        <div className="hero-content">
          ...
          <p className="hero-description body-large">
            Results-driven Data Scientist with expertise in the complete machine learning lifecycle. 
            Specializing in building, containerizing, and deploying end-to-end predictive models using 
